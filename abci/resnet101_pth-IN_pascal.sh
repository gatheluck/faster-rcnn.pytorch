...
python trainval_net.py -a resnet101 -j 16 -b 32 --cuda -l logs/resnet101_pth-IN_pascal -r result.json --bb_weight data/models/resnet101_pth-IN.pth --checkpoint 10 --mGPUs --num_epochs 50 
