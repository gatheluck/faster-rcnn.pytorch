...
python trainval_net.py -a resnet50 -j 16 -b 48 --cuda -l logs/resnet50_rge-SIN-IN-ft_pascal -r result.json --bb_weight data/models/resnet50_rge-SIN-IN-ft.pth --checkpoint 10 --mGPUs --num_epochs 50