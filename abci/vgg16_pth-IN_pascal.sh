...
python trainval_net.py -a vgg16 -j 16 -b 64 --cuda -l logs/vgg16_pth-IN_pascal -r result.json --bb_weight data/models/vgg16_pth-IN.pth --checkpoint 10 --mGPUs --num_epochs 50 
