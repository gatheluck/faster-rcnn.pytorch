...
python trainval_net.py -a resnet50 -j 16 -b 48 --cuda -l logs/resnet50_pth-IN_pascal -r result.json --bb_weight data/models/resnet50_pth-IN.pth --checkpoint 10 --mGPUs --num_epochs 50 